...
def func(x,tensoes,correntes):
    ...
    gray_cpl_V_tapped_wp = np.empty(shape=[len(gray_grid_I_tapped)],dtype=object)
    ...
    return [desnormalizedout,desnormalizedout_wp_test,np.mean(errorhist[k])]

#[ind01out,controlout,error] = func(res,window_size,addressSize,tensoes,correntes)
