...
fig1=plt.figure(1)
plt.title('Corrente gerada pela rede neural vs controlador convencional.')
plt.xlabel('tempo(s)')
plt.ylabel('Corrente(kA)')
plt.plot(np.arange(len(controlout))[2000:3000],controlout[2000:3000],'b',label="Controle")
plt.plot(np.arange(len(controlout))[2000:3000],ind01out[2000:3000],'r',label="Rede neural")
leg=plt.legend()
